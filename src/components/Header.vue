...
const props = defineProps({
    ...
    // esta prop viene del padre en su evento ounMounted es para mostrar 
    // una principal una oferta o algo por el estilo
    guitarra: {
        type: Object,
        required: true
    }
...
// si quiero acceder a carrito en el swcript debe ser props.carrito
